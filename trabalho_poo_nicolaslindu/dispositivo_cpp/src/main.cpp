...
int main() {
    ...
    // getStatus() avalia o estado real da bomba e devolve o texto para o JSON.
    // Encapsulado na classe Bomba, seguindo o mesmo padrão de statusNivel() e statusPressao().
